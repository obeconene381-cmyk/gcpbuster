...
# --- دالة النقر البشري المحسنة ---
async def human_click(page, locator):
    """محاكاة النقر البشري مع حركة الماوس"""
    try:
        ...
        # في حالة الفشل، استخدم النقر العادي
        try:
...
# --- دالة Start Lab (القديمة الصحيحة) ---
...
# --- دالة الكابتشا المحسنة باستخدام النقر البشري ---
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            if await click_start_lab_button(page):
                ...
                # الضغط على الكابتشا بالطريقة البشرية
